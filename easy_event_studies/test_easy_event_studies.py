...
def test_create_event_study_output(mock_dataframe_stock_data, mock_dataframe_fama_french_factors):
    ...
    t_stat_1 = 17.0 / np.sqrt(15.0)  # CAR / sqrt(Variance_CAR) for day 1
    ...
    expected_data = {
        ...
        'Actual_Return': [6.0, 8.0, 10.0, 12.0, 16.0],
        ...
        'Variance_CAR': [pd.NA, pd.NA, pd.NA, 8.0, 15.0],
        'CI_lower_bound_95': [pd.NA, pd.NA, pd.NA, 
                            8.0 - t_critical * np.sqrt(8.0),
                            17.0 - t_critical * np.sqrt(15.0)],
